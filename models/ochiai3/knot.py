...
if __name__ == "__main__":
    ...
    points = read_haken_svg("ochiai3.svg")
    ...
    ps.init()
    curve = ps.register_curve_network("ochiai3_subdivided", points_array, edges_array)
